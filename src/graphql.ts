...
export abstract class IMutation {
    ...
    abstract updateRole(id: string, updateInput?: RoleInput): Role | Promise<Role>;

    abstract updateRolePermissions(id: string, permissions?: PermissionInput[]): Role | Promise<Role>;

    abstract createUser(createInput?: CreateUserInput): User | Promise<User>;

    abstract deleteUser(id: string): boolean | Promise<boolean>;

    abstract updateUser(id: string, updateInput: UpdateUserInput): User | Promise<User>;
}
...
export abstract class IQuery {
    abstract roles(input?: PaginateRoleInput): PaginateRoleResult | Promise<PaginateRoleResult>;

    abstract role(id: string): Role | Promise<Role>;

    abstract users(input?: PaginateUserInput): PaginateUserResult | Promise<PaginateUserResult>;
